...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/tiler-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15392&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/tiler-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `tiler` can be installed with:

```
conda install tiler
```

It is possible to list all of the versions of `tiler` available on your platform with:
